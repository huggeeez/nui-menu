...
RegisterNetEvent('nui-menu:client:openMenu', function(data, sort, skipFirst)
    openMenu(data, sort, skipFirst)
end)

RegisterNetEvent('nui-menu:client:closeMenu', function()
    closeMenu()
end)
...
RegisterNUICallback('closeMenu', function(_, cb)
    ...
    SetNuiFocus(false)
    cb('ok')
    TriggerEvent("hz-menu:client:menuClosed")
end)
...
-- test
RegisterCommand('testmenu3', function(args, rawCommand)
    openMenu({
        {
            header = "HAMPAPLANTA | UTVECKLING",
        ...
        },
        {
            ...
            params = {
                event = "nui-menu:client:testMenu2",
                args = {
                    number = 1,
                }
            }
